...
if (!storage.local.get('users')) {
    const defaultUsers = [
        { name: 'Tarun', phone: '1234567890', password: 'Tarun@1234', role: 'admin', registeredAt: new Date().toISOString() },
...
if (!storage.local.get('touristPlaces') || storage.local.get('touristPlaces').length === 0) {
    const defaultPlaces = [
        { id: 1, name: 'Kanaka Durga Temple', image: 'images/kanaka.jpg', description: 'Located on Indrakeeladri Hill beside Krishna River. One of the most visited temples in Andhra Pradesh.', address: 'Indrakeeladri, Vijayawada, Andhra Pradesh 520001' },
        { id: 2, name: 'Prakasam Barrage', image: 'images/barrage.jpg', description: 'Beautiful bridge across Krishna River. Evening lighting makes it a must-visit location.', address: 'Prakasam Barrage, Vijayawada, Andhra Pradesh 520003' },
        { id: 3, name: 'Bhavani Island', image: 'images/bhavani.jpg', description: 'One of the largest river islands in India. Famous for boating and family outings.', address: 'Bhavani Island, Krishna River, Vijayawada, Andhra Pradesh' },
        { id: 4, name: 'Undavalli Caves', image: 'images/undavalli.jpg', description: 'Ancient rock-cut caves known for historical architecture and the reclining Vishnu statue.', address: 'Undavalli, Guntur, Andhra Pradesh 522501' }
    ];
